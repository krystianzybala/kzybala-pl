# Performance Lab Curriculum Specification

## Purpose

TBD — defines the curriculum-level guarantees for Performance Lab: how planned and implemented laboratories are catalogued, sequenced, and evidenced, independent of any single lab's implementation.
