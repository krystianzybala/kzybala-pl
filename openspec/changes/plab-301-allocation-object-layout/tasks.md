...
- [ ] 7. Create the required visual explanations: byte layout diagram, logical vs physical size, allocation flame graph.
- [ ] 8. Add terminology, assumptions and a short pre-lab diagnostic question.
- [ ] 9. Document the known traps: ignoring alignment; using packed unaligned fields unsafely; comparing object graph with reduced functionality; measuring only construction.
- [ ] 10. Add accessible textual/table fallbacks for every essential visualization.

## 3. Java Implementation

- [ ] 11. Implement the Java baseline and required variants with focus on JOL, compressed references, records/classes, arrays, TLAB behavior and allocation profiling.
...
- [ ] 16. Implement the Rust baseline and required variants with focus on size_of, repr variants, Box/Vec, enum niche optimization and allocator behavior.
...
- [ ] 21. Add parameter coverage for: orders/quotes, tree nodes, small tuples.
- [ ] 22. Execute or wire the required variants: boxed object graph, flat primitive arrays, packed off-heap struct, reused mutable holder.
...
- [ ] 40. Run `openspec validate plab-301-allocation-object-layout --strict` and repository quality gates.
