...
- [ ] 7. Create the required visual explanations: escape graph, allocation elimination report, latency/allocation crossover.
- [ ] 8. Add terminology, assumptions and a short pre-lab diagnostic question.
- [ ] 9. Document the known traps: assuming every new allocates; using disabled EA as production recommendation; comparing stack Rust value to heap Java object with different semantics; not checking materialization.
- [ ] 10. Add accessible textual/table fallbacks for every essential visualization.

## 3. Java Implementation

- [ ] 11. Implement the Java baseline and required variants with focus on Escape analysis, allocation elimination, object identity, synchronization elimination and diagnostics.
...
- [ ] 16. Implement the Rust baseline and required variants with focus on Stack values, moves, borrowing, Option/result aggregates and explicit heap boxing.
...
- [ ] 21. Add parameter coverage for: small coordinate/value object, result wrapper, temporary parser state.
- [ ] 22. Execute or wire the required variants: non-escaping aggregate, returned object, stored into field, passed to opaque call, identity hash or synchronization.
...
- [ ] 40. Run `openspec validate plab-203-escape-analysis-scalar-replacement --strict` and repository quality gates.
