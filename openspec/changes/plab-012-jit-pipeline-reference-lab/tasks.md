...
- [ ] 9. Document the known traps: timing Java before warm-up and Rust after optimization; treating one warm-up threshold as universal; forcing compilation flags without explaining them; claiming JIT always wins or loses.
- [ ] 10. Add accessible textual/table fallbacks for every essential visualization.

## 3. Java Implementation

- [ ] 11. Implement the Java baseline and required variants with focus on Bytecode, interpreter, C1/C2 tiers, compilation logs, code cache and deoptimization.
...
- [ ] 16. Implement the Rust baseline and required variants with focus on AOT compilation as the contrast: optimization levels, monomorphization and code generation before execution.
...
- [ ] 21. Add parameter coverage for: small polymorphic call chain, numeric kernel, branch profile shift.
- [ ] 22. Execute or wire the required variants: cold invocation, tiered warm-up, steady-state compiled, forced deoptimization, Rust debug vs release as anti-example.
