...
- [ ] 7. Create the required visual explanations: record layout diagram, cache-line occupancy view, throughput by accessed-field ratio.
- [ ] 8. Add terminology, assumptions and a short pre-lab diagnostic question.
- [ ] 9. Document the known traps: changing semantics across layouts; forgetting padding; measuring construction instead of scan; assuming SoA always wins.
- [ ] 10. Add accessible textual/table fallbacks for every essential visualization.

## 3. Java Implementation

- [ ] 11. Implement the Java baseline and required variants with focus on Records/classes, primitive arrays, MemorySegment layouts and Vector API eligibility.
...
- [ ] 16. Implement the Rust baseline and required variants with focus on repr(C) structs, Vec<Struct>, parallel Vec fields and alignment.
...
- [ ] 21. Add parameter coverage for: market-like quotes, positions with hot and cold fields, spatial points.
- [ ] 22. Execute or wire the required variants: AoS heap objects, AoS packed/off-heap, SoA primitive vectors, hybrid hot/cold split.
...
- [ ] 40. Run `openspec validate plab-105-aos-vs-soa --strict` and repository quality gates.
