# Design: Cache Locality and Working-Set Size
...
2. **Visualization** provides a deterministic or data-driven model: memory hierarchy diagram, latency staircase, working-set crossover chart.
3. **Java track** builds the baseline and optimized variants with focus on Primitive arrays, pointer-rich objects, sequential/random access and pre-touching.
4. **Rust track** builds equivalent variants with focus on Vec, boxed nodes, sequential/random indexing and explicit capacity.
...
- Criterion
- perf stat
- perf c2c where available
- async-profiler cache-miss profile
...
- Primary focus: Primitive arrays, pointer-rich objects, sequential/random access and pre-touching.
...
- Primary focus: Vec, boxed nodes, sequential/random indexing and explicit capacity.
